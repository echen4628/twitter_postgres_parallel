...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/echen4628/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/echen4628/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/echen4628/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/echen4628/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/echen4628/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/echen4628/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        |  19 seconds               | 63 seconds                | 
| `pg_normalized_batch`  |  543 seconds              | 10 seconds                | 
| `pg_denormalized`      |  180 seconds              | <1 second                 | 
